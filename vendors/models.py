...
class VendorSector(BaseModel, SoftDeleteModel, TimeStampedModel, models.Model):
    """
    Model representing a Vendor Sector.

    Attributes:
        user (ForeignKey): The user associated with the vendor sector.
        sector (ForeignKey): The sector associated with the vendor sector.

    Methods:
        __str__(): Returns a string representation of the VendorSector instance.
    ...
    def __str__(self):
        return str(self.sector) + "(" + str(self.user) + ")"
