    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job', models.ForeignKey(blank=True, db_column='job', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_job', to='jobs.jobdetails', verbose_name='Job')),
                ('job_filter', models.ForeignKey(blank=True, db_column='job_filter', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_job_filter', to='jobs.jobfilters', verbose_name='Job Filter')),
