...
class CreateCountrySerializers(serializers.ModelSerializer):
    """
    Serializer class for the `Country` model.

    The `CreateCountrySerializers` class extends `serializers.ModelSerializer`
    ...
    class Meta:
        model = Country
        fields = ['title', 'currency_code', 'country_code', 'iso_code2', 'iso_code3']
